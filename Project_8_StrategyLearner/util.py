...
def symbol_to_path(symbol, base_dir=None):
    ...
    if base_dir is None:
        base_dir = os.environ.get("MARKET_DATA_DIR", '/home/mike/OMCS/CS7646-ML For Trading/CS7646_Assignments/data')
...
def get_learner_data_file(basefilename):
    return open(os.path.join(os.environ.get("LEARNER_DATA_DIR",'/home/mike/OMCS/CS7646-ML For Trading/CS7646_Assignments/data/decision_tree_data'),basefilename),'r')
